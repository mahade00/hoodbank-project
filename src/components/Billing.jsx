...
const Billing = () =>(
        ...
        <div className={layout.sectionInfo}>
            ...
            <div className='flex flex-row flex-wrap sm:mt-10 mt-6'>
                <img src={apple} alt='google__play' className='w-[120px] h-[42px] object-contain mr-5 cursor-pointer'/>
                <img src={google} alt='google__play' className='w-[120px] h-[42px] object-contain mr-5 cursor-pointer'/>
            </div>
